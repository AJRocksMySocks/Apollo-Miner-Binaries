...
pushd "%~dp0"
.\apollo-miner.exe -host us-east.stratum.slushpool.com -port 3333 -user NinjaFluffBTC/1CDKNme5jaMXwEVXKxczSJh89TFwfQuUxy -pswd futurebit123 -comport COM3 -brd_ocp 48  -osc 30 -ao_mode 1
pause
